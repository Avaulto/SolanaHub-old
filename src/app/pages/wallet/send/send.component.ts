  ...
  async send() {
    ...
    // try {
      if (privateTx) {
        ...
        const toFill = new Uint8Array(10);
        const buff = crypto.randomFillSync(toFill);
        ...
        const elusiv = await Elusiv.getElusivInstance(buff, walletOwnerPublicKey, this._solanaUtilsService.connection); // this line return err
        console.log(elusiv)
